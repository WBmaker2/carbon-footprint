(function () {
  const ITEMS = [
    ...
    },
    {
      ...
      description: "에어컨이나 온풍기를 사용한 시간을 30분씩 기록해요.",
      tip: "교실이 충분히 시원하거나 따뜻할 때는 에어컨이나 온풍기 사용 시간을 줄여 볼 수 있어요.",
    },
  ];
  ...
  const ECO_LEVELS = [
    {
      ...
      label: "좋음",
      className: "good",
      description: "학생들이 조절할 수 있는 쓰레기와 에어컨·온풍기 사용이 잘 관리되고 있어요.",
    },
    {
      maxCarbon: 1.8,
      label: "보통",
      className: "normal",
      description: "기본 조명은 괜찮아요. 쓰레기나 에어컨·온풍기 사용을 조금 더 줄여 보면 좋아요.",
    },
    {
      maxCarbon: Number.POSITIVE_INFINITY,
      label: "주의",
      className: "alert",
      description: "에어컨·온풍기 사용이나 쓰레기 발생이 많아요. 줄일 수 있는 부분을 다시 살펴보세요.",
    },
  ];
